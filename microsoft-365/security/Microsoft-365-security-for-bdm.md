...
|**İş yapmadığınız ülkelerden gelen bağlantıları engelleyin**. Bu ülkelerden gelen bağlantıları engellemek için bir Azure AD koşullu erişim ilkesi oluşturun ve kiracınızın çevresinde etkili bir şekilde coğrafi güvenlik duvarı oluşturun.||![yeşil onay işareti.](../media/green-check-mark.png)|
...
|Öneri|E3|E5|
|---|---|---|
|**Office 365 için Microsoft Defender yapılandırma**:<ul><li>Güvenli Ekleri Kaydetme</li><li>Güvenli Bağlantılar</li><li>SharePoint, OneDrive ve Microsoft Teams için Güvenli Ekler</li><li>Kimlik avı önleme ilkelerinde kimliğe bürünme koruması</li></ul>||![yeşil onay işareti.](../media/green-check-mark.png)|
|**Uç Nokta için Microsoft Defender özelliklerini yapılandırma**:<ul><li>Windows Defender Virüsten Koruma</li><li>Exploit Protection</li><li>Saldırı yüzeyini azaltma</li><li>Donanım tabanlı yalıtım</li><li>Denetimli klasör erişimi</li></ul>||![yeşil onay işareti.](../media/green-check-mark.png)|
...
- Uzak PowerShell'i tüm kullanıcılar için devre dışı bırakın; uzak PowerShell çoğunlukla yöneticiler tarafından yönetim amacıyla veya programlı API erişimi için hizmetlere erişmek için kullanılır. Yönetici olmayan kullanıcıların erişecekleri bir iş gereksinimi olmadığı sürece keşiften kaçınmaları için bu seçeneği devre dışı bırakmanızı öneririz.
...
|**Office 365 için Microsoft Defender** araçlarını kullanın: <ul><li>Tehdit araştırması ve yanıt özellikleri</li><li>Otomatik araştırma ve yanıt</li></ul>||![yeşil onay işareti.](../media/green-check-mark.png)|
|**Uç Nokta için Microsoft Defender** kullanın: <ul><li>[Uç nokta algılama ve yanıt](/windows/security/threat-protection/microsoft-defender-atp/overview-endpoint-detection-response)</li><li>Otomatik araştırma ve düzeltme Güvenli puan</li><li>[Gelişmiş avcılık örneği](/windows/security/threat-protection/microsoft-defender-atp/advanced-hunting-overview)</li></ul>||![yeşil onay işareti.](../media/green-check-mark.png)|
...
- **Riskli oturum açma bilgilerini haftalık olarak gözden geçirme** — Riskli oturum açmaları haftalık olarak gözden geçirmek için Azure AD yönetim merkezini kullanın. Önerilen kimlik ve cihaz erişim kural kümesi, riskli oturum açma işlemleri için parola değişikliğini zorunlu kılmaya yönelik bir ilke içerir.
