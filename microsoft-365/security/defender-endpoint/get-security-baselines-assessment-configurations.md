...
ms.locfileid: "65369626"
---
# <a name="list-security-baselines-assessment-configurations"></a>Güvenlik temelleri değerlendirme yapılandırmalarını listeleme
...
- OData tarafından desteklenen işleçler:
  - `$filter` açık:  `id`,  `category`,  `name`, `CCE`
...
|:---|:---|:---|
|Kimliği | Dize | Temel karşılaştırmadaki belirli yapılandırma için benzersiz tanımlayıcı.
