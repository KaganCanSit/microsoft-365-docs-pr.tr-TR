...
## <a name="1-export-software-inventory-assessment-odata"></a>1. Yazılım envanteri değerlendirmesini (OData) dışarı aktarma
...
>
>-Yanıtta bazı ek sütunlar döndürül olabilir. Bu sütunlar geçicidir ve kaldırılabilir, lütfen yalnızca belgelenmiş sütunları kullanın.
...
>
>_ Verilerinizin en yüksek indirme hızı için, verilerinizin bulunduğu Azure bölgesinden indirmeye emin olun.
>
Özellik (Kimlik) | Veri türü | Açıklama | Döndürülen değer örneği
:---|:---|:---|:---
