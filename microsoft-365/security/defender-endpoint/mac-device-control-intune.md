---
title: Intune için cihaz denetim ilkelerine örnekler
description: Intune ile kullanılmaktadır örnekleri kullanarak cihaz denetim ilkelerini kullanmayı öğrenin.
keywords: microsoft, defender, Endpoint için Microsoft Defender, mac, cihaz, denetim, usb, çıkarılabilir, medya, intune
...
---
# <a name="examples-of-device-control-policies-for-intune"></a>Intune için cihaz denetim ilkelerine örnekler
...
Bu belgede, kendi organizasyonunız için özelleştirebileceğiniz cihaz denetimi ilkelerinin örnekleri yer aldı. Bu örnekler, intune kullanarak kuruluş cihazları yönetmek için kullanıyorsanız uygulanabilir.

## <a name="restrict-access-to-all-removable-media"></a>Tüm çıkarılabilir medyaya erişimi kısıtlama

Aşağıdaki örnek, tüm çıkarılabilir medyaya erişimi kısıtlar. İlkenin `none` en üst düzeyinde uygulanan izinlere dikkat olun; bu, tüm dosya işlemlerine izin verilmeyecek anlamına gelir.
