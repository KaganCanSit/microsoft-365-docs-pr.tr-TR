...
- Değerlendirme laboratuvarı geliştirmeleri: Artık laboratuvara Windows 11 ve Linux cihazları ekleyebilirsiniz. 

- Android ve iOS için tehdit ve güvenlik açığı yönetimi genel kullanıma sunuldu. [Daha fazla bilgi edinin](https://techcommunity.microsoft.com/t5/microsoft-defender-for-endpoint/announcing-general-availability-of-vulnerability-management/ba-p/3071663).
