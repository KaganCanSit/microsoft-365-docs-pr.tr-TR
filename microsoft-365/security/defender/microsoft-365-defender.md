...
description: Microsoft 365 Defender, cihazları, kimlikleri, verileri ve uygulamaları korumak için tasarlanmış, eşgüdümlü bir tehdit koruması çözümüdür.
keywords: MMicrosoft 365 Defender'a giriş, siber güvenlik, gelişmiş kalıcı tehdit, kurumsal güvenlik, cihazlar, cihaz, kimlik, kullanıcılar, veriler, uygulamalar, olaylar, otomatik araştırma ve düzeltme, gelişmiş tarama
...
Microsoft 365 Defender gelişmiş saldırılara karşı tümleşik koruma sağlamak için uç noktalar, kimlikler, e-posta ve uygulamalar genelinde algılama, önleme, soruşturma ve yanıt için yerel olarak eşgüdüm sağlayan birleşik bir ihlal öncesi ve ihlal sonrası kurumsal savunma paketidir.

Tümleşik Microsoft 365 Defender çözümüyle, güvenlik uzmanları bu ürünlerden her biri için tehdit sinyallerini bir arada hazırlar ve tehdidin tam kapsamını ve etkisini, ortama nasıl gir olduğunu, bundan nasıl etkilendiğini ve şu anda kuruluşu nasıl etkile ilgili olduğunu belirler. Microsoft 365 Defender, saldırıyı ve etkilenen kendi kendine etkilenen posta kutularını, uç noktaları ve kullanıcı kimliklerini engellemek veya durdurmak için otomatik bir işlem gerekir.
...
## <a name="microsoft-365-defender-interactive-guide"></a>Microsoft 365 Defender etkileşimli kılavuz

Bu etkileşimli kılavuzda, iş yerleriyle birlikte organizasyonlarınızı nasıl Microsoft 365 Defender. Güvenlik risklerini algılamanıza Microsoft 365 Defender, organizasyonunıza saldırılar araştırmanıza ve zararlı etkinlikleri otomatik olarak önlemeye nasıl yardımcı olduğunu burada öğrensiniz.

[Etkileşimli kılavuza göz atabilirsiniz](https://aka.ms/M365Defender-InteractiveGuide)
...
Microsoft 365 Defender'in benzersiz ürün arası katmanı tek tek hizmet bileşenlerini şu şekilde geliştirmektedir:

- Sinyal paylaşımı ve otomatik eylemler aracılığıyla saldırılardan korunmaya ve hizmet genelinde savunma yanıtları koordine etmeye yardımcı olur.
- Ürün uyarıları, davranışlar ve güvenlik ekipleri için güvenlik ekiplerine karşı saldırının tüm anlatımlarını, şüpheli olaylar ve 'olaylar' için etkide olan varlıklarla ilgili verileri bir arada kullanarak anlatım.
- Otomatik düzeltme yoluyla etkilenen varlıklar için öz etkiyi tetikleerek ödüne karşı otomatik yanıt otomatikleştirin.
- Güvenlik ekiplerinin uç nokta genelinde ayrıntılı ve etkili tehdit avı gerçekleştirmelerini ve verilerinizi Office etkinleştirin.
...
- **Microsoft 365 Defender portalında** çapraz ürün tek cam bölmesi - Algılamalar, etkiyi olan varlıklar, alınan otomatik işlemler ve ilgili kanıtlarla ilgili tüm bilgiler için tek bir sırada ve <a href="https://go.microsoft.com/fwlink/p/?linkid=2077139" target="_blank">Microsoft 365 Defender portalında</a> tek bir bölme için merkezi bir görünüm. 
...
Bu <a href="https://go.microsoft.com/fwlink/p/?linkid=2077139" target="_blank">Microsoft 365 Defender merkezi</a> bir yerde, e-postaya,  işbirliğine *, kimlike*, cihaza ve uygulama tehditlerine karşı koruma, *algılama, soruşturma* ve yanıt bir araya geldi. 
...
Arama çubuğu sayfanın en üstünde yer alıyor. Siz yazarak, varlıkları daha kolay bulmanı kolaylaştırmak için öneriler sağlanır. İyileştirilmiş arama sonuçları sayfası, tüm varlıklardan sonuçları merkezi hale gösterir.
...
- **Dosyalar, IP'ler ve URL'ler** - Uç Nokta için Defender'dakiyle aynı özelliklerdir.
    ...
    >[!NOTE]
    >IP ve URL aramaları tam olarak eştir ve arama sonuçları sayfasında görünmez; doğrudan varlık sayfasına doğru ilerlerler. 

- **TVM** - Uç Nokta için Defender'dakiyle aynı özelliklerdir (güvenlik açıkları, yazılım ve öneriler). 
...
<a href="https://go.microsoft.com/fwlink/p/?linkid=2077139" target="_blank">Microsoft 365 Defender portalında</a> Microsoft güvenlik blogu, YouTube'daki Microsoft güvenlik topluluğu ve aynı zamanda Microsoft'ta resmi belgeler gibi kaynaklardan gelen resmi rehberlikten bilgi edinen bir docs.microsoft.com.
...
Geri bildiriminize ihtiyacımız var. Her zaman geliştirmek için arıyoruz, bu nedenle görmek istediğim bir şey varsa, geri bildiriminizi okumamız için bize nasıl güven güvenebilirsiniz diye bu [videoyu izleyin](https://www.microsoft.com/videoplayer/embed/RE4K5Ci).
...
### <a name="explore-what-the-microsoft-365-defender-portal-has-to-offer"></a>Portalda Microsoft 365 Defender neler olduğunu keşfedin
...
Microsoft Learn'in bu öğrenme yolu ile, güvenliğin tehditlerini Microsoft 365 Defender, denetlemeye ve düzeltmeye nasıl yardımcı olduğunu anlıyoruz.

|Eğitim:|Siber saldırıları algıla ve bu saldırılara Microsoft 365 Defender|
|---|---|
|![Microsoft 365 Defender simgesi.](../../media/microsoft-365-defender/m365-defender-secure-organization.svg)|Microsoft 365 Defender karmaşık siber saldırılara karşı tümleşik koruma sağlamak için tehdit işaretlerini uç noktalar, kimlikler, e-posta ve uygulamalar genelinden alır. Microsoft 365 Defender, olayları araştıran, yanıtlayan ve devam eden kötü amaçlı siber güvenlik etkinliklerini önceden aramak için merkezi bir deneyimdir.<p> 1 sa 38 dak . Learning - 5 Modüller|
