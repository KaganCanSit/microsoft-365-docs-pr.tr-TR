...
<a href="https://go.microsoft.com/fwlink/p/?linkid=2077139" target="_blank">Microsoft 365 Defender portalı</a>, koruma, algılama, araştırma ve *e-posta*, *işbirliği*, *kimlik*, *cihaz* ve *uygulama* tehditlerine verilen yanıtı merkezi bir yerde birleştirir.

Bu tek bölme, Microsoft 365 Defender portalı ve Office 365 Güvenlik & Uyumluluk merkezi gibi mevcut Microsoft güvenlik portallarından işlevleri bir araya getirir. Microsoft 365 Defender portalı bilgilere hızlı erişimi, daha basit düzenleri vurgular ve daha kolay kullanım için ilgili bilgileri bir araya getirir. İçindekiler:
...
- **[Microsoft 365 Defender](microsoft-365-defender.md)**, etki alanları arasında tehdit verilerini otomatik olarak çözümlemek ve tek bir panoda saldırının resmini oluşturmak için Microsoft 365 güvenlik portföyünden yararlanan *Microsoft'un Genişletilmiş Algılama ve Yanıt* (XDR) çözümünün bir parçasıdır.
...
Office 365 Güvenlik & Uyumluluk merkezinden veya Microsoft 365 Defender portalından nelerin değiştiği hakkında bilgiye ihtiyacınız varsa bkz:
...
> [!NOTE]
> Microsoft 365 Defender portalı mevcut rol tabanlı erişimi kullanır ve zorlar ve her güvenlik modelini birleşik portala taşır. Yakınsanmış her iş yükünün kendi rol tabanlı erişimi vardır. Ürünlerdeki roller otomatik olarak Microsoft 365 Defender portalına yakınsanır. Ancak Microsoft Defender for Cloud Apps kendi rollerini ve izinlerini işlemeye devam eder.

Microsoft 365 Defender'daki yeni birleşik portal hakkında bilgi edinmek için bu kısa videoyu izleyin.  
> [!VIDEO https://www.microsoft.com/en-us/videoplayer/embed/RWBKau]

### <a name="what-to-expect"></a>Bekleyebileceğiniz şeyler

<a href="https://go.microsoft.com/fwlink/p/?linkid=2077143" target="_blank">Office 365 Güvenlik & Uyumluluk Merkezi'nde</a> ve Microsoft 365 güvenlik merkezi kullandığınız tüm güvenlik içeriği artık <a href="https://go.microsoft.com/fwlink/p/?linkid=2077139" target="_blank">Microsoft 365 Defender portalında</a> bulunabilir.
...
Microsoft 365 Defender *, Office 365 için Microsoft Defender ve Uç Nokta için Microsoft Defender birleştirildiğinde birlik, netlik ve ortak hedefleri* vurgular. Birleştirme, aşağıda listelenen öncelikleri temel alır ve her güvenlik paketinin aşağıdakilerin birleşimine getirdiği özelliklerden ödün vermeden yapılır:

- Ortak yapı taşları
- Ortak terminoloji
- Ortak varlıklar
- Diğer iş yükleriyle özellik eşliği
...
### <a name="unified-investigations"></a>Birleşik araştırmalar

Güvenlik bilgilerinin merkezileştirilmesi, Microsoft 365 genelindeki güvenlik olaylarını araştırmak için tek bir yer oluşturur. En önemli örnek, **Microsoft 365 Defender** hızlı başlatılmasıyla ilgili **uyarılar & Olaylar'dır**.

:::image type="content" source="../../media/converged-incidents-2.png.png" alt-text="Microsoft 365 Defender portalındaki Olaylar sayfası" lightbox="../../media/converged-incidents-2.png.png":::

Olay adı seçildiğinde, güvenlik bilgilerini merkezileştirmenin değerini gösteren bir sayfa görüntülenir.
...
Olay sayfasının üst kısmında **Özet**, **Uyarılar**, **Cihazlar**, **Kullanıcılar**, **Posta Kutuları**, **Araştırmalar**, **Kanıt ve yanıt ve** **Graph** sekmelerini görürsünüz. Daha ayrıntılı bilgi için bu sekmeleri seçin. Örneğin, **Kullanıcılar** sekmesi yakınsanmış iş yüklerinden (Uç Nokta için Microsoft Defender, Kimlik için Microsoft Defender ve Microsoft Defender for Cloud Apps) kullanıcılara yönelik bilgileri ve örneğin bir dizi kaynağı görüntüler şirket içi Active Directory Domain Services (AD DS), Azure AD ve üçüncü taraf kimlik sağlayıcıları. Daha fazla bilgi için bkz. [Kullanıcıları araştırma](investigate-users.md).

Ortamınızdaki olayları gözden geçirmek, bu sekmelerde detaya gitmek ve farklı tehdit türlerine yönelik olaylar için sağlanan bilgilere nasıl erişeceklerini anlamak için zaman ayırın.
...
> [!NOTE]
> Microsoft 365 Defender'daki Uç Nokta için Microsoft Defender, [yönetilen güvenlik hizmeti sağlayıcılarına (MSSP) Microsoft 365 Defender](/windows/security/threat-protection/microsoft-defender-atp/grant-mssp-access) [portalında erişim verildiği şekilde erişim verilmesini](./mssp-access.md) destekler.
...
#### <a name="quickly-view-your-microsoft-365-environment"></a>Microsoft 365 ortamınızı hızla görüntüleme
...
- **Kimlikler**- Kuruluşunuzdaki kimlikleri izleyin ve şüpheli veya riskli davranışları izleyin. [Kimlik koruması hakkında daha fazla bilgi edinin](/azure/active-directory/identity-protection/overview-identity-protection).
- **Veri** - Yetkisiz verilerin açığa çıkmasına neden olabilecek kullanıcı etkinliğini izlemeye yardımcı olun.
- **Cihazlar** - Cihazlarınızdaki uyarılar, ihlal etkinliği ve diğer tehditler hakkında güncel bilgiler edinin.
- **Uygulamalar** - Kuruluşunuzda bulut uygulamalarının nasıl kullanıldığı hakkında içgörü elde edin. [Bulut için Defender Uygulamaları'nda bulunan uygulamalar hakkında daha fazla bilgi edinin](/cloud-app-security/discovered-apps).
...
- **Kullanıcılar** - Uç Nokta için Defender, Kimlik için Defender ve Bulut için Defender Uygulamaları için desteklenir. 
...
### <a name="threat-analytics-with-better-data-coverage"></a>Daha iyi veri kapsamına sahip tehdit analizi

Aşağıdaki Microsoft 365 Defender tehdit analizi tümleşik deneyimiyle yeni ortaya çıkan tehditleri izleyin ve yanıt verin:

- Uç Nokta için Microsoft Defender ve Office 365 için Microsoft Defender arasında daha iyi veri kapsamı sağlayarak birleşik olay yönetimi, otomatik araştırma, düzeltme ve etki alanı genelinde proaktif veya reaktif tehdit avcılığı mümkün hale gelir.
- e-postayla ilgili algılamalar ve Uç Nokta için Microsoft Defender'dan sağlanan uç nokta verilerine ek olarak Office 365 için Microsoft Defender'den azaltmalar.
- Uyarıları Uç Nokta için Microsoft Defender ve Office 365 için Microsoft Defender genelinde uçtan uca saldırı öykülerine toplayarak iş kuyruğunuzu azaltmanın yanı sıra araştırmanızı basitleştiren ve hızlandıran tehditle ilgili olayların görünümü.
- Microsoft 365 Defender çözümleri tarafından algılanan ve engellenen saldırı girişimleri. Ayrıca, daha fazla maruz kalma riskini azaltan ve dayanıklılığı artıran önleyici eylemler uygulamak için kullanabileceğiniz veriler de vardır.
- Raporlara acilen odaklanmak, araştırmak ve raporlardan yararlanmak için verileri hızla tanımlamanıza yardımcı olmak için eyleme dönüştürülebilir bilgileri öne çıkartan gelişmiş tasarım.

### <a name="a-centralized-learning-hub"></a>Merkezi bir Learning Merkezi

<a href="https://go.microsoft.com/fwlink/p/?linkid=2077139" target="_blank">Microsoft 365 Defender portalı</a>, Microsoft güvenlik blogu, YouTube'daki Microsoft güvenlik topluluğu ve docs.microsoft.com'daki resmi belgeler gibi kaynaklardan resmi rehberliği kabartan bir öğrenme merkezi içerir.

Öğrenme hub'ındaki E-posta & İşbirliği (Office 365 için Microsoft Defender) kılavuzu Uç Nokta (Uç Nokta için Microsoft Defender) ve Microsoft 365 Defender öğrenme kaynaklarıyla yan yanadır.

Öğrenme hub'ı açılır ve "Microsoft 365 Defender Kullanarak Araştırma?" gibi konularda düzenlenmiş Learning yolları vardır. ve "Office 365 için Microsoft Defender En İyi Yöntemler". Bu bölüm şu anda Microsoft içindeki güvenlik Ürün Grubu tarafından seçilmiştir. Her Learning yolu, kavramların üzerinden geçmek için gereken tahmini süreyi yansıtır. Örneğin , 'Office 365 için Microsoft Defender kullanıcı hesabının güvenliği aşıldığında atılması gereken adımlar' 8 dakika sürecek şekilde tahmin edilir ve anında öğrenme açısından değerlidir.

İçeriğe tıkladıktan sonra, bu siteye yer işareti eklemek ve yer işaretlerini bir 'Güvenlik' veya 'Kritik' klasörüne düzenlemek yararlı olabilir. Tüm Learning yollarını görmek için ana paneldeki Tümünü göster bağlantısına tıklayın.
...
> [!TIP]
> [Microsoft Learn'de](/learn/) birçok başka öğrenme fırsatı vardır. [Kurs MS-500T02-A: Microsoft 365 Tehdit Koruması Uygulama gibi sertifika eğitimlerini](/learn/certifications/courses/ms-500t02) bulacaksınız.
...
Bu makaleden geri bildirim de bırakabilirsiniz. 'Geri bildirim gönder ve görüntüle' altındaki sonundaki 'Geri Bildirim' bölümünde, seçenekler *Bu ürün* veya *Bu sayfa'dır*.

Ürün geri bildirimi için **Bu ürün** düğmesini kullanın:

1. Makalenin alt kısmındaki *Bu ürün'e* tıklayın.
    1. Bu yönergeleri okumaya devam etmek istiyorsanız düğmeye sağ tıklayın ve "Yeni bir sekmede aç".
2. Bu, **UserVoice forumunu** gösterir.
3. 2 seçeneğiniz vardır:
    1. *Office 365'da uyumluluğu nasıl geliştirebiliriz veya kullanıcılarınızı nasıl daha iyi koruyabiliriz?* metin kutusuna gidin ve *Microsoft 365 Defender* yapıştırın. Sizinki gibi bir fikir için sonuçlarda arama yapabilir ve bu fikri oylayabilir veya **Yeni bir fikir gönder** düğmesini kullanabilirsiniz.
    1. Bu sorunun zaten bildirildiğinden eminseniz ve profilini bir oy (veya oy) ile yükseltmek istiyorsanız, UserVoice'un sağ tarafındaki *Geri BildirimDeğer Ver* kutusunu kullanın. *Microsoft 365 Defender* arayın, **sorunu bulun ve durumunu yükseltmek için oy düğmesini kullanın**.

Makalenin kendisi hakkında geri bildirim için *Bu sayfayı* kullanın. Geri bildiriminiz için teşekkür ederiz. Sesiniz ürünleri geliştirmemize yardımcı olur.
