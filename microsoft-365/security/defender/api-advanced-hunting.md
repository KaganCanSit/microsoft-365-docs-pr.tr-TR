...
-|-|-
Uygulama | AdvancedQuery.Read.All| Gelişmiş sorguları çalıştırma
Temsilcili (iş veya okul hesabı) | AdvancedQuery.Read | Gelişmiş sorguları çalıştırma
