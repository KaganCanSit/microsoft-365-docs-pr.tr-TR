...
|**İletişim Uyumluluğu**|Yönetici, analist, analist ve görüntüleyici gibi tüm iletişim uyumluluk rollerine izinler sağlar.|Vaka Yönetimi <p> İletişim Uyumluluğu Yöneticisi <p> İletişim Uyumluluğu Çözümlemesi <p> İletişim Uyumluluğu Olay Yönetimi <p> İletişim Uyumluluğu İncelemesi <p> İletişim Uyumluluğu Görüntüleyicisi <p> Veri Sınıflandırma Geri Bildirim Sağlayıcısı <p> View-Only Durumu|
|**İletişim Uyumluluğu Yöneticileri**|İlkeleri oluştur/düzenleyebilir ve genel ayarları tanımlayan iletişim uyumluluğu yöneticileri.|İletişim Uyumluluğu Yöneticisi <p> İletişim Uyumluluğu Olay Yönetimi|
...
|**Uyumluluk Yöneticisi1**<sup></sup>|Üyeler cihaz yönetimi, veri kaybı önleme, raporlar ve saklama ayarlarını yönetebilir.|Vaka Yönetimi <p> İletişim Uyumluluğu Yöneticisi <p> İletişim Uyumluluğu Olay Yönetimi <p> Uyumluluk Yöneticisi <p> Uyumluluk Araması <p> Veri Sınıflandırma Geri Bildirim Sağlayıcısı <p> Veri Sınıflandırma Geri Bildirimi Gözden Geçiren <p> Veri Araştırma Yönetimi <p> Cihaz Yönetimi <p> Disposition Management <p> DLP Uyumluluk Yönetimi <p> Bekle <p> IB Uyumluluk Yönetimi <p> Bilgi Koruması Yöneticisi <p> Bilgi Koruma Analisti <p> Bilgi Koruma Koruma Koruma Koruması <p> Bilgi Koruma Okuyucusu <p> Insider Risk Yönetimi Yöneticisi <p> Uyarıları Yönetme <p> Kuruluş Yapılandırması <p> RecordManagement <p> Bekletme Yönetimi <p> View-Only Günlüklerini Denetleme <p> View-Only Durumu <p> View-Only Yönetimi <p> View-Only DLP Uyumluluk Yönetimi <p> View-Only IB Uyumluluk Yönetimi <p> View-Only Yönetme <p> View-Only'i seçin <p> View-Only Kaydı Yönetimi <p> View-Only Bekletme Yönetimi|
|**Uyumluluk Veri Yöneticisi**|Üyeler cihaz yönetimi, veri koruması, veri kaybını önleme, raporlar ve saklama ayarlarını yönetebilir.|Uyumluluk Yöneticisi <p> Uyumluluk Araması <p> Cihaz Yönetimi <p> Disposition Management <p> DLP Uyumluluk Yönetimi <p> IB Uyumluluk Yönetimi <p> Bilgi Koruması Yöneticisi <p> Bilgi Koruma Analisti <p> Bilgi Koruma Koruma Koruma Koruması <p> Bilgi Koruma Okuyucusu <p> Uyarıları Yönetme <p> Kuruluş Yapılandırması <p> RecordManagement <p> Bekletme Yönetimi <p> Duyarlılık Etiketi Yöneticisi <p> View-Only Günlüklerini Denetleme <p> View-Only Yönetimi <p> View-Only DLP Uyumluluk Yönetimi <p> View-Only IB Uyumluluk Yönetimi <p> View-Only Yönetme <p> View-Only'i seçin <p> View-Only Kaydı Yönetimi <p> View-Only Bekletme Yönetimi|
|**Uyumluluk Yöneticisi Yöneticileri**|Şablon oluşturma ve değiştirme yönetme.|Uyumluluk Yöneticisi Yönetimi <p> Uyumluluk Yöneticisi Değerlendirmesi <p> Uyumluluk Yöneticisi Katkı <p> Uyumluluk Yöneticisi Okuyucu|
|**Uyumluluk Yöneticisi Değerlendirenler**|Değerlendirmeler oluşturun, geliştirme eylemleri gerçekleştirin ve geliştirme eylemleri için test durumunu güncelleştirin.|Uyumluluk Yöneticisi Değerlendirmesi <p> Uyumluluk Yöneticisi Katkı <p> Uyumluluk Yöneticisi Okuyucu|
|**Uyumluluk Yöneticisi Katkıda Bulunanlar**|Değerlendirmeler oluşturun ve geliştirme eylemleri gerçekleştirmek için çalışma gerçekleştirin.|Uyumluluk Yöneticisi Katkı <p> Uyumluluk Yöneticisi Okuyucu|
...
|**Kuruluş Yönetimi1**<sup></sup>|Üyeler Güvenlik Ayarları Uyumluluk Merkezi'nde özelliklere erişim izinlerini & ayrıca cihaz yönetimi, veri kaybını önleme, raporlar ve saklama ayarlarını yönetebilir. <p> Genel yönetici değilseniz, Microsoft 365 için Exchange Temel Mobil Kullanım ve Güvenlik (eski adı Mobil Cihaz Yönetimi veya MDM) tarafından yönetilen cihazları görmek ve bu cihazlar üzerinde eylem yapmak için genel yönetici olması gerekir. <p> Genel yöneticiler otomatik olarak bu rol grubunun üyeleri olarak eklenir.|Denetim Günlükleri <p> Vaka Yönetimi <p> İletişim Uyumluluğu Yöneticisi <p> İletişim Uyumluluğu Olay Yönetimi <p> Uyumluluk Yöneticisi <p> Uyumluluk Araması <p> Cihaz Yönetimi <p> DLP Uyumluluk Yönetimi <p> Bekle <p> IB Uyumluluk Yönetimi <p> Insider Risk Yönetimi Yöneticisi <p> Uyarıları Yönetme <p> Kuruluş Yapılandırması <p> Karantina <p> RecordManagement <p> Bekletme Yönetimi <p> Rol Yönetimi <p> Arama ve Temizleme <p> Güvenlik Yöneticisi <p> Güvenlik Okuyucu <p> Duyarlılık Etiketi Yöneticisi <p> Duyarlılık Etiket Okuyucusu <p> Hizmet Güvencesi Görünümü <p> Etiket Katkıda Bulunan <p> Etiket Yöneticisi <p> Etiket Okuyucu <p> View-Only Günlüklerini Denetleme <p> View-Only Yönetimi <p> View-Only DLP Uyumluluk Yönetimi <p> View-Only IB Uyumluluk Yönetimi <p> View-Only Durumu <p> View-Only Yönetme <p> View-Only'i seçin <p> View-Only Kaydı Yönetimi <p> View-Only Bekletme Yönetimi|
