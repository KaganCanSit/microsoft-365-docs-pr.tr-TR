...
(<a id="fn3">3</a>) İş için Defender'da otomatik araştırma ve yanıt varsayılan olarak kiracı genelinde açılır. Otomatik araştırmayı ve yanıtı kapatırsanız gerçek zamanlı korumayı etkiler. Gelişmiş [özellikler için bkz. Ayarları gözden geçirme](mdb-configure-security-settings.md#review-settings-for-advanced-features).  
