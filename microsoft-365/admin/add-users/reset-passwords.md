...
ms.locfileid: "66601684"
---
# <a name="reset-passwords-in-microsoft-365-for-business"></a>İş için Microsoft 365'te parolaları sıfırlama

YouTube'da [Microsoft 365 küçük işletme yardımına](https://go.microsoft.com/fwlink/?linkid=2197659) göz atın.

Bu makalede, microsoft 365 İş aboneliğiniz olduğunda parolaları kendiniz ve kullanıcılarınız için nasıl sıfırladığınız açıklanmaktadır.
...
[YouTube kanalımızda](https://go.microsoft.com/fwlink/?linkid=2198204) bu videoya ve diğer videolara göz atın.

> [!VIDEO https://www.microsoft.com/videoplayer/embed/RE1FVVP]

1. Kullanıcı yeni bir parola istediğinde, e-postada parola sıfırlama isteği alırsınız. Parolayı sıfırlamak için uygulama başlatıcısını açın ve **Yönetici'ı** seçin.
