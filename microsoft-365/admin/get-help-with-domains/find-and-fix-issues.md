...
Etki alanınızı bu etki alanıyla çalışacak Microsoft 365 zor olabilir. DNS sistemiyle çalışmak oldukça zordur ve etki alanınız için DNS kurulumu, e-posta gibi önemli iş etkinliklerinizi etkileyebilir!
...
Etki alanınızı Microsoft 365'e eklerken, normalde etki alanınıza gönderilen TÜM e-postaların Microsoft 365'a işaret etmek üzere etki alanı MX kaydı (siz veya Microsoft 365 tarafından) güncelleştirilir ve bu etki alanına gönderilen TÜM e-postaların Microsoft 365. MX kaydını değiştirmeden ÖNCE, Microsoft 365 etki alanınıza e-postası olan herkes için posta kutuları oluşturduğunuzdan emin olun.
  
Etki alanınız içinde yer alan herkesin e-postalarını başka yere taşımak istemiyorsanız Microsoft 365? Bunun yerine yalnızca birkaç [e-Microsoft 365 e-posta adresiyle pilot uygulama adımlarını atabilirsiniz](../setup/domains-faq.yml).
...
Yalnızca kuruluşun etki alanını doğrulamanız ve herhangi bir hizmet ayarlamamanız gereken birkaç senaryo vardır. Örneğin, kuruluşlarının bir okul Microsoft 365 uygun olduğunu kanıtlamaya yardımcı olmak için.
  
Sahipliği, kar amacı gütmeyen [kuruluş Microsoft 365](../setup/domains-faq.yml) eğitim durumunu kanıtlamak ya da gerekli tüm adımları tamamlamış olup olmadığınızı doğrulamak için Yammer etki alanını doğrulama konusunda yer alan kılavuza göz atabilirsiniz. Her durum için biraz farklıdır. 
  
## <a name="services-not-working-with-your-domain"></a>Etki alanınızdaki hizmetler çalışmıyor mu?

Etki alanınızın DNS kurulumuyla ilgili sorunları düzeltmenize yardımcı olabiliriz. Düzeltilen ve Microsoft 365 olan tüm kayıtları ve kayıtların tam olarak hangi ayara ayarlanmış olması gerekenleri etki alanı sorun gidericisi size gösterir. 

> [!TIP]
> DNS'iniz doğru ayarlanmış ama masaüstünüzde Outlook çalışmıyor mu? İşletmeniz [için doğru ayarlanmış şeyler olduğundan emin olmak için Microsoft 365](/exchange/mail-flow-best-practices/mail-flow-best-practices) posta akış senaryolarıyla birlikte sahip olanızay farklı posta akışı senaryolarına göz atabilirsiniz. Veya burada e-postayla ilgili daha fazla sorun giderme yardımı alın: [Sorunları Outlook düzeltin](/exchange/troubleshoot/outlook-connectivity/outlook-connection-issues). 
...
- A kaydınızı veya CNAME kaydınızı web sitenize işaret etmek üzere güncelleştire Microsoft 365 [](../setup/add-domain.md)
