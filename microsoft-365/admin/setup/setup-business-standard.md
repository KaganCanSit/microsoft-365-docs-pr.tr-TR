...
## <a name="set-up-microsoft-365-for-business"></a>İş için Microsoft 365 ayarlama
...
4. Etki alanının sahibi olduğunuzu doğrulayan [Office 365 için herhangi bir DNS barındırma sağlayıcısında DNS kayıtları oluşturma](/office365/admin/get-help-with-domains/create-dns-records-at-any-dns-hosting-provider) adımlarını izleyin. Etki alanı konağınızı biliyorsanız bkz. [Microsoft 365 için etki alanı ekleme](/microsoft-365/admin/setup/add-domain).
...
2. Sihirbazdaki adımları izleyin; e-posta ve diğer hizmetler sizin için ayarlanır.
    ...
    Kaydolma işlemi tamamlandığında yönetim merkezine yönlendirilirsiniz; burada Office uygulamaları yüklemek, etki alanınızı eklemek, kullanıcı eklemek ve lisans atamak için bir sihirbazı izlersiniz. İlk kurulumu tamamladıktan sonra, aboneliklerinizle birlikte gelen hizmetleri ayarlamaya ve yapılandırmaya devam etmek için yönetim merkezindeki **Kurulum** sayfasını kullanabilirsiniz.
...
### <a name="step-set-up-outlook-for-email"></a>Adım: E-posta için Outlook ayarlama

1. Windows Başlat menüsü Outlook arayın ve seçin.

    (Mac kullanıyorsanız araç çubuğundan Outlook açın veya Bulucu'yı kullanarak bulun.)

    Outlook yüklediyseniz, Hoş Geldiniz sayfasında **İleri'yi** seçin.

2. **Dosya** \> **Bilgileri** \> **Hesap Ekle'yi** seçin.

3. Microsoft e-posta adresinizi girin ve **Bağlan'ı** seçin.

## <a name="watch-set-up-outlook-for-email"></a>İzleyin: E-posta için Outlook ayarlama

> [!VIDEO https://www.microsoft.com/videoplayer/embed/9fe86884-8a83-42cc-bca9-61a12e6dad31?autoplay=false]
  
Daha fazla bilgi için bkz[. E-posta için Outlook ayarlama](https://support.microsoft.com/office/f5bf0cd1-e1f3-4b0d-a022-ecab17efe86f).
  
### <a name="import-email"></a>E-posta içe aktarma

Outlook başka bir e-posta hesabıyla kullanıyorsanız, önceki e-postanızı, takviminizi ve kişilerinizi yeni Microsoft hesabınıza aktarabilirsiniz.
  
1. **Eski e-postanızı dışarı aktarma**

    In Outlook, choose **File** \> **Open &amp; Export** \> **Import/Export**.

    **Dosyaya Aktar'ı** seçin ve ardından Outlook Veri Dosyanızı (.pst) ve tüm alt klasörleri dışarı aktarmak için adımları izleyin.

2. **Eski e-postanızı içeri aktarma**

    Outlook'da **Dosya** \> **Aç &amp; Dışarı Aktarma** \> **İçeri/Dışarı Aktarma** yeniden seçin.
...
[Outlook ile e-postayı içeri aktarma](https://support.microsoft.com/office/6a3771d4-4c1d-4a25-92a6-0b8e476335de) konusunda daha fazla bilgi edinin.

Ayrıca, herkesin e-postasını içeri aktarmak için <a href="https://go.microsoft.com/fwlink/p/?linkid=2059104" target="_blank">Exchange yönetim merkezini</a> de kullanabilirsiniz. Daha fazla bilgi için bkz. [Birden çok e-posta hesabını geçirme](/Exchange/mailbox-migration/mailbox-migration).

## <a name="set-up-microsoft-teams-and-onedrive-for-business"></a>İş için Microsoft Teams ve OneDrive ayarlama

Görev çubuğunuzdaki OneDrive bulut simgesini seçin ve dosyalarınızı yeni OneDrive İş klasörünüze taşımak için adımları izleyin. Microsoft Teams ayarlamak için **İleri'yi** seçin.

1. Microsoft Teams açın, profil simgenizi seçin ve ardından **İş veya okul hesabı ekle'yi** seçin. Yeni hesabınızı Teams eklemek için adımları izleyin.
