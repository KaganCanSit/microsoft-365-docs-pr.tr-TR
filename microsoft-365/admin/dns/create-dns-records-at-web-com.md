...
2. Aşağıdaki tabloda yer alan değerleri kullanarak iki ad sunucusu kaydı oluşturun veya var olan ad sunucusu kayıtlarını bu değerlerle eş olacak şekilde düzenleyin.
    ...
    |||
    |:-----|:-----|
    |İlk ad sunucusu  <br/> |Etki alanı tarafından sağlanan ad sunucusu web.com.  <br/> |
    |İkinci ad sunucusu  <br/> |Etki alanı tarafından sağlanan ad sunucusu web.com.  <br/> |
...
1. Aşağıdaki tabloda yer alan değerleri seçin veya kopyalayıp yapıştırın.
    ...
    |:-----|:-----|:----|
    |@  <br/> |MS=ms *XXXXXXXX*  <br/> **Not:** Bu bir örnektir. Tablodan **, belirli Hedef veya Adres Noktaları** değerinizi burada kullanın.  [Bunu nasıl bulabilirim?](../get-help-with-domains/information-for-dns-records.md)    |1 Saat  <br/> |
...
1. Aşağıdaki tabloda yer alan değerleri seçin veya kopyalayıp yapıştırın. 
    ...
    |:-----|:-----|:-----|:-----| 
    | @ |*\<domain-key\>*  .mail.protection.outlook.com  <br/> **Not:** Microsoft yönetim  *\<domain-key\>*  merkezinden kendi sürümünizi edinin.   [How do I find this?](../get-help-with-domains/information-for-dns-records.md) | For more information about priority, see [What is MX priority?](../setup/domains-faq.yml) <br/> 1| 1 Saat  <br/> |
...
1. Aşağıdaki tabloda yer alan değerleri seçin veya kopyalayıp yapıştırın. 
    ...
    |:-----|:-----|:-----|:-----|
    | Diğer Ana Bilgisayar  <br/>| autodiscover  <br/>| autodiscover.outlook.com  <br/> | 1 Saat  <br/>  |
...
1. Aşağıdaki tabloda yer alan değerleri seçin veya kopyalayıp yapıştırın. 
    ...
    |:-----|:-----|:-----|
    |@  <br/> |v=spf1 include:spf.protection.outlook.com -all  <br/> **Not:** Tüm boşlukların doğru kalması için bu girdiyi kopyalayıp yapıştırarak bu dosyayı yapıştırın.  | 1 Saat  <br/> 
...
1. Aşağıdaki tabloda yer alan değerleri seçin veya kopyalayıp yapıştırın.
    ...
    |:-----|:-----|:-----|:-----|:-----|:-----|:-----|:-----|
    | SRV |_sip  <br/> |TLS  <br/> |100  <br/> |443  <br/> |sipdir.online.lync.com  <br/> **Bu değer nokta (.) ile sona ERER.** <br/> | 1  <br/> | 1 Saat  <br/> |
    | SRV |_sipfederationtls  <br/> |TCP <br/> |100  <br/> |5061  <br/> |sipfed.online.lync.com  <br/> **Bu değer nokta (.) ile sona ERER.** <br/> |1  <br/> | 1 Saat  <br/> |
...
1. Aşağıdaki tabloda yer alan değerleri seçin veya kopyalayıp yapıştırın. 
    ...
    |:-----|:-----|:-----|:-----|:-----|
    | CNAME | Diğer Ana Bilgisayar | sip  <br/> |sipdir.online.lync.com  <br/> **Bu değer nokta (.) ile sona ERER.** <br/> |1 Saat  <br/> |
    | CNAME| Diğer Ana Bilgisayar | lyncdiscover  <br/> |webdir.online.lync.com  <br/> **Bu değer nokta (.) ile sona ERER.** <br/> | 1 Saat  <br/> |
...
1. Aşağıdaki tabloda yer alan değerleri seçin veya kopyalayıp yapıştırın.
    ...
    | **Tür**|**Başvuru | Ana Bilgisayar Adı**|**Diğer Ad**| **TTL** |
    |:-----|:-----|:-----|:-----|:-----|
    | CNAME | Diğer Ana Bilgisayar | enterpriseregistration  <br/> |enterpriseregistration.windows.net  <br/> **Bu değer nokta (.) ile sona ERER.** <br/> | 1 Saat  <br/> |
    | CNAME | Diğer Ana Bilgisayar |enterpriseenrollment  <br/> |enterpriseenrollment-s.manage.microsoft.com  <br/> **Bu değer nokta (.) ile sona ERER.** <br/> | 1 Saat  <br/> |
