...
1. Yeni kayıt kutularına, aşağıdaki tablodaki değerleri yazın ya da bu tablodan kopyalayıp yapıştırın.
    ...
    |:-----|:-----|:-----|:-----|:-----|
    |(Bu alanı boş bırakın.)|TXT - E-posta gönderenleri doğrulamak için kullanılır|MS=*msXXXXXXXX* <br/> **Not:** Bu bir örnektir. Hedef veya Adres **Noktaları değerinizi burada**, hedef tablodaki Microsoft 365. [Bunu nasıl bulabilirim?](../get-help-with-domains/information-for-dns-records.md)|300|Basit|
...
1. Yeni kayıt kutularına, aşağıdaki tablodaki değerleri yazın ya da bu tablodan kopyalayıp yapıştırın.
    ...
    |:-----|:-----|:-----|:-----|:-----|
    |autodiscover|CNAME - Trafiği başka bir etki alanı adına yollar|autodiscover.outlook.com. <br/> **Bu değer nokta (.) ile bitmelidir.**|300|Basit|
