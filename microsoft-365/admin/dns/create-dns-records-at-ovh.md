---
title: OVH'deki DNS kayıtlarınızı Microsoft 365 Bağlan
f1.keywords:
- CSH
ms.author: efrene
author: efrene
...
description: Microsoft için OVH'de etki alanınızı doğrulamayı ve e-posta, Skype for Business Online ve diğer hizmetler için DNS kayıtlarını ayarlamayı öğrenin.
ms.openlocfilehash: 3b3174860a65d13d68b2d5f7773f927dd706f1a0
ms.sourcegitcommit: ac0ae5c2888e2b323e36bad041a4abef196c9c96
ms.translationtype: MT
ms.contentlocale: tr-TR
ms.lasthandoff: 04/12/2022
ms.locfileid: "64780423"
---
# <a name="connect-your-dns-records-at-ovh-to-microsoft-365"></a>OVH'deki DNS kayıtlarınızı Microsoft 365 Bağlan

Aradığınızı bulamazsanız, [Etki Alanları SSS sayfasını inceleyin](../setup/domains-faq.yml).

DNS barındırma sağlayıcınız OVH ise, etki alanınızı doğrulamak ve e-posta, Skype for Business Online vb. için DNS kayıtlarını ayarlamak için bu makaledeki adımları izleyin.

OvH'de bu kayıtları ekledikten sonra, etki alanınız Microsoft hizmetleri ile çalışacak şekilde ayarlanır.
