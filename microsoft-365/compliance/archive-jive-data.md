---
title: Microsoft 365'da Jive verilerini arşivleme için bağlayıcı ayarlama
f1.keywords:
- NOCSH
...
Jive verileri kullanıcı posta kutularında depolandıktan sonra, Dava Tutma, eBulma, bekletme ilkeleri ve bekletme etiketleri ve iletişim uyumluluğu gibi Microsoft Purview özelliklerini uygulayabilirsiniz. Microsoft 365'da verileri içeri aktarmak ve arşivlemek için Jive bağlayıcısı kullanmak, kuruluşunuzun kamu ve mevzuat ilkeleriyle uyumlu kalmasına yardımcı olabilir.

## <a name="overview-of-archiving-jive-data"></a>Jive verilerini arşivleme genel bakış

Aşağıdaki genel bakış, Jive verilerini Microsoft 365'de arşivleme amacıyla bağlayıcı kullanma işlemini açıklar.

![Jive verileri için iş akışı arşivleme.](../media/JiveConnectorWorkflow.png)

1. Kuruluşunuz bir Jive sitesi ayarlamak ve yapılandırmak için Jive ile birlikte çalışır.

2. Her 24 saatte bir, Jive öğesindeki öğeler Veritas Merge1 sitesine kopyalanır. Bağlayıcı ayrıca Jive öğelerinin içeriğini e-posta iletisi biçimine dönüştürür.

3. Uyumluluk portalında oluşturduğunuz Jive bağlayıcısı her gün Veritas Merge1 sitesine bağlanır ve içeriği Microsoft bulutunda güvenli bir Azure Depolama konumuna aktarır.

4. Bağlayıcı, [3. Adımda](#step-3-map-users-and-complete-the-connector-setup) açıklandığı gibi otomatik kullanıcı eşlemesinin *Email* özelliğinin değerini kullanarak dönüştürülen öğeleri belirli kullanıcıların posta kutularına aktarır. Kullanıcı posta kutularında Gelen Kutusu klasöründe **Jive** adlı yeni bir alt klasör oluşturulur ve öğeler bu klasöre aktarılır. Bağlayıcı bunu *Email* özelliğinin değerini kullanarak yapar. Her Jive öğesi, öğenin her katılımcısının e-posta adresiyle doldurulmuş olan bu özelliği içerir.
...
## <a name="step-1-set-up-the-jive-connector"></a>1. Adım: Jive bağlayıcısını ayarlama

İlk adım, uyumluluk portalındaki **Veri Bağlayıcıları** sayfasına erişmek ve Jive verileri için bir bağlayıcı oluşturmaktır.

1. Adresine gidin ve **Veri bağlayıcılarıJive'e** > [https://compliance.microsoft.com](https://compliance.microsoft.com/) tıklayın.
...
## <a name="step-2-configure-the-jive-connector"></a>2. Adım: Jive bağlayıcısını yapılandırma

İkinci adım, Jive bağlayıcısını Merge1 sitesinde yapılandırmaktır. Jive bağlayıcısını yapılandırma hakkında bilgi için bkz. [Birleştirme1 Üçüncü Taraf Bağlayıcıları Kullanıcı Kılavuzu](https://docs.ms.merge1.globanetportal.com/Merge1%20Third-Party%20Connectors%20Jive%20User%20Guide.pdf).
...
1. **Jive kullanıcılarını Microsoft 365 kullanıcılara eşle** sayfasında otomatik kullanıcı eşlemesini etkinleştirin. Jive öğeleri, kuruluşunuzdaki kullanıcıların *e-posta* adreslerini içeren E-posta adlı bir özellik içerir. Bağlayıcı bu adresi bir Microsoft 365 kullanıcıyla ilişkilendirebiliyorsa, öğeler söz konusu kullanıcının posta kutusuna aktarılır.
...
## <a name="step-4-monitor-the-jive-connector"></a>4. Adım: Jive bağlayıcısını izleme

Jive bağlayıcısını oluşturduktan sonra bağlayıcının durumunu uyumluluk portalında görüntüleyebilirsiniz.
...
2. **Bağlayıcılar** sekmesine tıklayın ve açılır sayfayı görüntülemek için **Jive** bağlayıcısını seçin. Bu sayfa, bağlayıcı hakkındaki özellikleri ve bilgileri içerir.
