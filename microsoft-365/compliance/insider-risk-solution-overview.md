---
title: Insider risk çözümleri
description: Kuruluş içinde Insider risk çözümleriyle organizasyon riskini en aza indirmeye nasıl yardımcı Microsoft 365.
...
ms.locfileid: "63005445"
---
# <a name="insider-risk-solutions-in-microsoft-365"></a>Insider risk çözümleri Microsoft 365
...
![Insider riski tehditlerine karşı koruma sağlar.](../media/ir-solution-threats.png)
...
| Risk simgesi | Riskler | İletişim uyumluluğu | Insider risk yönetimi | Bilgi engelleri | Ayrıcalıklı erişim yönetimi |
| :---- | :-------- | :--------------------------- | :-------------------------- |:-------------------------| :--------------------------------|
| ![Veri taşma simgesi.](../media/ir-risk-data-spillage.png)| Veri taşma | ![Destekleniyor](../media/check-mark.png) | ![Destekleniyor](../media/check-mark.png) |  |  |
...
| ![IP hırsızlık simgesi.](../media/ir-risk-ip-theft.png)| IP hırsızlığı | ![Destekleniyor](../media/check-mark.png) | ![Destekleniyor](../media/check-mark.png) | ![Destekleniyor](../media/check-mark.png) |  |
| ![İş yerinde şiddet simgesi.](../media/ir-risk-workplace-violence.png)| İş yerinde şiddet | ![Destekleniyor](../media/check-mark.png) |  |  |  |
| ![Sahtekarlık/sahtekarlık simgesi.](../media/ir-risk-fraud.png)| Dolandırıcılık | ![Destekleniyor](../media/check-mark.png) | ![Destekleniyor](../media/check-mark.png) |  |  |
...
| ![Insider işlem/el sıkışması simgesi.](../media/ir-risk-insider-trading.png)| Insider alım satım | ![Destekleniyor](../media/check-mark.png) |  |  |  |
| ![İlgi alanla ilgili çakışmalar simgesi.](../media/ir-risk-conflicts-of-interest.png)| İlgi çakışmaları | ![Destekleniyor](../media/check-mark.png) |  | ![Destekleniyor](../media/check-mark.png) |  |
...
| ![İş yerinde taciz/kişiler simgesi.](../media/ir-risk-workplace-harassment.png)| İş yerinde taciz | ![Destekleniyor](../media/check-mark.png) |  |  |  |
...
| ![Yasal düzenlemelere uyumluluk ihlalleri simgesi.](../media/ir-risk-regulatory-compliance-violations.png)| Mevzuat uyumluluğu ihlalleri | ![Destekleniyor](../media/check-mark.png) | ![Destekleniyor](../media/check-mark.png) | ![Destekleniyor](../media/check-mark.png) |  |

## <a name="microsoft-365-insider-risk-solutions"></a>Microsoft 365 insider risk çözümleri
...
- Office 365 Kurumsal E3 aboneliği + Office 365 Gelişmiş Uyumluluk eklentiyi içerir (artık yeni abonelikler için kullanılamaz)
...
- Microsoft 365 E3 + Microsoft 365 E5 Koruma ve Yönetim eklentiniz
- Microsoft 365 A3 + Uyumluluk Microsoft 365 A5 eklentiyi ekleme
- Microsoft 365 A3 + Microsoft 365 A5 Koruma ve Yönetim eklentiniz

## <a name="deploy-microsoft-365-insider-risk-solutions"></a>Insider risk Microsoft 365 dağıtma

Organizasyonlarınızı Insider risklerine karşı korumak için aşağıdaki olası çözümleri ayarlayın Microsoft 365 dağıtın:

![Insider risk çözümünün savunması-derinlikli.](../media/ir-solution-defense-in-depth.png)
...
## <a name="illustrations-with-examples"></a>Örnekli çizimler
...
|:------------------|:--------------|
| Insider risklerini iş Microsoft 365 |[Tam öğrenme yolu](/learn/paths/m365-compliance-insider) <br> Bu öğrenme yolu, iletişim uyumluluğu, insider risk yönetimi, bilgi engelleri ve ayrıcalıklı erişim yönetimi için tek tek tüm çözüm modüllerini içerir. Tüm modülleri tamamlamak için bu öğrenme yolunu seçin. |
...
| Insider risk yönetimi | [Learning modülü: Risk yönetiminde Insider Microsoft 365](/learn/modules/m365-compliance-insider-manage-insider-risk) <br> Bu modül, Microsoft 365'ta insider risk yönetiminin kuruluşta dahili riskleri engellemeye, algılamaya ve içereci nasıl yardımcı olduğunu öğrenmenıza, yerleşik, önceden tanımlanmış ilke şablonları türleri hakkında bilgi edinme ve Insider risk ilkeleri oluşturmadan önce gereken temel önkoşulları anlamanıza yardımcı olur ve Insider risk yönetimi durumlarında gerçekleştirebilecek eylem türlerini açıklamanıza yardımcı olur. |
| Bilgi engelleri | [Learning: Bilgi engellerini planlama](/learn/modules/m365-compliance-insider-plan-information-barriers) <br> Bu modül, bilgi engeli ilkelerinin ilgili endüstri standartları ve yasal düzenlemelere uyumluluğu korumanıza nasıl yardımcı olduğunu öğrenmenize, bilgi engellerinin uygulan uygulanabildiği durum türlerini listeler, bilgi engeli ilkesi oluşturma sürecini açıklamaya ve bilgi engeli uygulanmaya başladıktan sonra beklenmedik sorunların nasıl giderilmesine yardımcı olduğunu açıklamanıza yardımcı olur. |
| Ayrıcalıklı erişim yönetimi | [Learning modülü: Ayrıcalıklı erişim yönetimini uygulama](/learn/modules/m365-compliance-insider-implement-privileged-access-management) <br> Bu modül, ayrıcalıklı erişim yönetimiyle ayrıcalıklı kimlik yönetimi arasındaki farkı anlamanıza, ayrıca erişim yönetim süreci akışını anlamanıza ve ayrıca erişim yönetimini yapılandırmanın ve etkinleştirmenin temellerini anlamanıza yardımcı olur. |
