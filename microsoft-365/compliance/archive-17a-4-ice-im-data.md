...
ICE Bağlan Sohbet verileri kullanıcı posta kutularında depolandıktan sonra, Dava Tutma, eBulma, bekletme ilkeleri ve bekletme etiketleri ve iletişim uyumluluğu gibi Microsoft Purview özelliklerini uygulayabilirsiniz. Microsoft 365'da verileri içeri aktarmak ve arşivlemek için ICE DataParser bağlayıcısı kullanmak, kuruluşunuzun kamu ve mevzuat ilkeleriyle uyumlu kalmasına yardımcı olabilir.
...
3. Microsoft Purview uyumluluk portalında oluşturduğunuz ICE DataParser bağlayıcısı DataParser'a bağlanır ve iletileri Microsoft bulutunda güvenli bir Azure Depolama konumuna aktarır.
...
İlk adım, uyumluluk portalındaki Veri bağlayıcıları sayfasına erişmek ve ICE Bağlan Sohbet verileri için bir 17a-4 bağlayıcısı oluşturmaktır.
