...
- **Geçmiş en iyi yöntemlerin uzun kuyruğu**: En iyi yöntemlerin ışık hızında değiştiğini fark edin. Azure AD'ye üç aydan uzun bir süre önce baktıysanız, büyük olasılıkla güncel değilsinizdir. Buradaki her şey yayından sonra değişebilir. "En iyi" seçenek bugünden itibaren altı ay sonra aynı olmayabilir.
...
Bu rol grupları doğrudan üyelik gerektirir ve Azure AD gruplarını içeremez. Ne yazık ki bugün bu rol grupları Azure AD PIM tarafından desteklenmemektedir. Azure AD rolleri gibi, bunların API'ler veya Saviynt gibi bir iş ortağı idare ürünü veya diğerleri aracılığıyla yönetilmesini önerme eğilimindeyim.
