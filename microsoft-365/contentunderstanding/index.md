...
Bu sayfada yer alan kaynaklar, e-postayı ve kullanım SharePoint Syntex için tasarlanmıştır.
...
> [!NOTE]
> SharePoint yönetim SharePoint Syntex merkezinden bir içerik merkezi oluşturarak, lisans [satın almadan SharePoint başlatabilirsiniz](create-a-content-center.md). Lisanssız kullanıcılar belge anlama modelleri oluşturabilir, ancak bunları belge kitaplığına uygulayamaz.
...
|Microsoft Tech Teknik Merkezi'Community kaynakları görme|[SharePoint Syntex - İçerik Hizmetleri Microsoft 365](https://techcommunity.microsoft.com/t5/sharepoint-syntex/bg-p/SharePointSyntex)|
...
İşle ilgili sorunlarınızı çözmenize yardımcı olmak için SharePoint Syntex sorunları nasıl kullanabileceğiniz ve nasıl uygulay İstanbul uygulaması kullanabileceğiniz hakkında daha fazla bilgi edinin.
...
|Örnek senaryolara bakarak, organizasyonda herhangi bir SharePoint Syntex hakkında fikir verme |[Senaryolar ve iş için kullanım SharePoint Syntex](./adoption-scenarios.md)| 
...
Bu bölümdeki kaynaklar, kendi ortamınıza Microsoft SharePoint Syntex'i ayarlaması ve Microsoft 365 yardımcı olur.
...
|Model eğitimleri için erişilebilirlik modunu kullanmayı öğrenin|[SharePoint Syntex modunda çalışma](./accessibility-mode.md)|

## <a name="premium-services"></a>Premium hizmetleri

Yeni SharePoint Syntex lisansı, kullanıcılarınıza son kullanıcı ortamınız içinde ek işlevler veren premium içerik Microsoft 365 verir. Bu bölümdeki kaynaklar, bu özellik ve bunların nasıl kullanımı hakkında daha fazla ayrıntı sağlar.
...
|İçerik türlerinin kitaplık ve listelerde daha tutarlı bir SharePoint nasıl kullanılabilir olduğunu öğrenin|[İçerik türlerini hub'a itme](./push-content-type-to-hub.md)|
...
| Bu bilgileri arıyorsanız: | Bu kaynağa gidin: |
|:-----|:-----|
|Modelleri belgeyle anlamak için REST API'lerini kullanma|[SharePoint Syntex anlama modeli REST API'sini anlama](/sharepoint/dev/apis/syntex/syntex-model-rest-api)|
