...
Bu makalede, kimlik ve cihaz erişimi için [parola karması eşitleme kimlik doğrulaması önkoşul yapılandırmasıyla karmanın](../security/office-365-security/identity-access-prerequisites.md#prerequisites) gereksinimlerini karşılayan bir Microsoft 365 test ortamının nasıl yapılandırıldığı açıklanır.
