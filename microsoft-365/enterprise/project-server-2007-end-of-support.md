...
2017'de Office 2007 sunucuları ve uygulamaları için destek sona erdi ve geçiş planlarını göz önünde bulundurmanız gerekiyor. Şu anda Project Server 2007 ve ilgili ürünleri kullanıyorsanız aşağıdaki destek sonu tarihlerini not edin:
...
Project Server 2007 kullanıyorsanız geçiş seçeneklerinizi incelemeniz gerekir; bunlar:
...
1. Proje planlarınızı Project Server 2003'ten .mpp biçimine kaydedin.
...
Project Online'da Microsoft Project Web App (PWA) yapılandırmanızı el ile oluşturabilirsiniz. Örneğin, gerekli özel alanları veya kurumsal takvimleri yeniden oluşturun. Microsoft İş Ortakları da bu işlemde yardımcı olabilir.
...
|[Project Server 2010'a Yükseltmeyi Planlama](/previous-versions/office/project-server-2010/ff603505(v=office.14)) <br/> |Sistem Gereksinimleri dahil olmak üzere Project Server 2007'den Project Server 2010'a yükseltirken dikkat edilmesi gereken planlama konuları  <br/> |
...
Verilerinizin başarıyla geçirildiğini doğruladıktan sonra, sonraki adım Project Server 2013'e geçiş yapmaktır.
...
|[Project Server 2013'e yükseltmeyi planlama](/project/plan-for-upgrade-to-project-server-2016) <br/> |Sistem Gereksinimleri dahil olmak üzere Project Server 2010'dan Project Server 2013'e yükseltirken dikkat edilmesi gereken planlama konuları <br/> |
...
- Yükseltme işlemi, Project Server 2010 verilerinizi yalnızca Project Server 2013 biçimine dönüştürmekle kalmaz, aynı zamanda dört Project Server 2010 veritabanını tek bir Project Web Uygulaması veritabanında birleştirir.
    
- 2013 sürümlerinde hem SharePoint Sunucusu hem de Project Sunucusu talep tabanlı kimlik doğrulaması olarak değiştirildi. Klasik kimlik doğrulaması kullanıyorsanız yükseltmeniz için bu faktörü göz önünde bulundurmanız gerekir. Daha fazla bilgi için bkz. [SharePoint 2013'te klasik moddan talep tabanlı kimlik doğrulamasına geçiş](/sharepoint/security-for-sharepoint-server/security-for-sharepoint-server).
    
Ek kaynaklar:
  
- [Project Server 2013'e yükseltme işlemine genel bakış](/project/overview-of-the-project-server-2016-upgrade-process)
    
- [Veritabanlarınızı ve Project Web Uygulaması site koleksiyonlarınızı yükseltme (Project Server 2013)](/project/upgrading-to-project-server-2016)
    
- [Microsoft Project Sunucusu yükseltme işlemi diyagramı](https://go.microsoft.com/fwlink/p/?linkid=841270)
    
- [8 Kolay Adımda Project Server 2010'a 2013 Geçişi için Harika Veritabanı Birleştirme](https://go.microsoft.com/fwlink/p/?linkid=841271)
...
Project Server 2013'ten Project Server 2016 yükseltmek için yapmanız gerekenlerin kapsamlı bir açıklaması için bkz. [Project Server 2016 yükseltme](//project/upgrading-to-project-server-2016).
