---
title: Belgeler için Microsoft Managed Desktop değiştirme
description: Bu makalede, bu makalenin yeni ve güncelleştirilmiş Microsoft Managed Desktop.
...
--- | ---
| [Cihaz resimleri](service-description/device-images.md) | Bölüm Windows 10 Pro eklendi |
| [Yönetici desteği](working-with-managed-desktop/admin-support.md) | Vaka ayrıntılarını düzenle bölümüne önem derecesi notu eklendi |
...
[Microsoft Managed Desktop yaşam döngüsünü geri arama](service-description/device-lifecycle.md) | Makale güncelleştirildi
[Sertifika ve ağ profillerini e-Microsoft Managed Desktop](get-ready/certs-wifi-lan.md) | Makale güncelleştirildi
[Hazırlık değerlendirme aracı tarafından bulunan sorunları düzeltme](get-ready/readiness-assessment-fix.md) | Makale güncelleştirildi
...
[Hazırlık değerlendirme aracı tarafından bulunan sorunları düzeltme](get-ready/readiness-assessment-fix.md) | Makale güncelleştirildi
[Microsoft Managed Desktop sorumluluklarını yerine getirme](intro/roles-and-responsibilities.md) | Makale güncelleştirildi
...
[Microsoft Managed Desktop ile Windows 11 ve test Microsoft Managed Desktop](working-with-managed-desktop/test-win11-mmd.md) | Yeni makale
[İş Ortakları'nın cihazları kaydetme adımları](get-started/partner-registration.md) | Makale güncelleştirildi
[Yeni cihazları kendiniz kaydettirin](get-started/manual-registration.md) |Makale güncelleştirildi
[Destek için Microsoft Managed Desktop](working-with-managed-desktop/admin-support.md) | Makale güncelleştirildi
[AutoPilot ve Kayıt Durumu Sayfası ile ilk çalıştırma deneyimi](get-started/esp-first-run.md) | Makale güncelleştirildi
[Microsoft Managed Desktop ve izleme](service-description/operations-and-monitoring.md) | Makale güncelleştirildi
...
[Destek için Microsoft Managed Desktop](working-with-managed-desktop/admin-support.md) | Makale güncelleştirildi
[Hazırlık değerlendirme aracı tarafından bulunan sorunları düzeltme](get-ready/readiness-assessment-fix.md) | Makale güncelleştirildi
[Microsoft Managed Desktop için önkoşullar](get-ready/prerequisites.md) | Makale güncelleştirildi
[Durum Enterprise'i etkinleştirme](get-started/enterprise-state-roaming.md) | Makale güncelleştirildi
...
Yeni veya değiştirilmiş makale | Açıklama
--- | ---
[Cihazları Microsoft Managed Desktop ayarlama](get-started/prepare-devices.md) | Makale güncelleştirildi
[Cihaz stok raporu](working-with-managed-desktop/device-inventory-report.md) | Makale güncelleştirildi
[Ağ yapılandırması Microsoft Managed Desktop](get-ready/network.md) | Makale güncelleştirildi
[Tanılama günlükleri](service-description/diagnostic-logs.md) | Yeni makale
[Microsoft Managed Desktop teknolojileri](intro/technologies.md) | Makale güncelleştirildi
[Konuk hesapları için önkoşullar](get-ready/guest-accounts.md) | Makale güncelleştirildi
[Raporlarla çalışma](working-with-managed-desktop/reports.md) | Makale güncelleştirildi
...
[Microsoft Managed Desktop için önkoşullar](get-ready/prerequisites.md) | Makale güncelleştirildi
[Microsoft Managed Desktop'de uygulamalar](get-ready/apps.md) | Makale güncelleştirildi
[Yeni cihazları doğrulama](get-started/validate-device.md) | Yeni makale
[Cihazları Microsoft Managed Desktop ayarlama](get-started/prepare-devices.md) | Makale güncelleştirildi
[Microsoft Managed Desktop yaşam döngüsünü geri arama](service-description/device-lifecycle.md) | Makale güncelleştirildi
[Microsoft Managed Desktop cihazları](service-description/device-list.md) |Makale güncelleştirildi
...
[Microsoft Managed Desktop desteklenen bölgeler](service-description/regions-languages.md) | Makale güncelleştirildi
...
[Güncelleştirmeler iş nasıl Microsoft Managed Desktop](service-description/updates.md) | Makale güncelleştirildi
[Yönetici portalına erişme](get-started/access-admin-portal.md) | Makale güncelleştirildi
...
[Eşlenmiş sürücüleri sürücüye Microsoft Managed Desktop](get-ready/mapped-drives.md) | Makale güncelleştirildi
[Kullanıcılar için yardım alma](working-with-managed-desktop/end-user-support.md) | Makale güncelleştirildi
[Yapılandırılabilir ayarlar başvurusu - Microsoft Managed Desktop](working-with-managed-desktop/config-setting-ref.md) | Makale güncelleştirildi
[Yapılandırılabilir ayarları dağıtma ve izleme - Microsoft Managed Desktop](working-with-managed-desktop/config-setting-deploy.md) | Makale güncelleştirildi
[Destek için Microsoft Managed Desktop](working-with-managed-desktop/admin-support.md) | Makale güncelleştirildi
[Microsoft Teams](get-started/teams.md) | Yeni makale
[Yönetici portalına erişme](get-started/access-admin-portal.md) | Yeni makale
[Yazdırma kaynaklarını diğer kaynaklara Microsoft Managed Desktop](get-ready/printing.md) | Makale güncelleştirildi
[AutoPilot ve Kayıt Durumu Sayfası ile ilk çalıştırma deneyimi](get-started/esp-first-run.md) | Makale güncelleştirildi
[Yeni cihazları kendiniz kaydettirin](get-started/manual-registration.md) | Makale güncelleştirildi
[Sertifika ve ağ profillerini e-Microsoft Managed Desktop](get-ready/certs-wifi-lan.md) | Makale güncelleştirildi
[Microsoft Managed Desktop için önkoşullar](get-ready/prerequisites.md) | Makale güncelleştirildi
...
[Yeni cihazları kendiniz kaydettirin](get-started/manual-registration.md) | Makale güncelleştirildi
[Mevcut cihazları kendiniz kaydettirin] (get-started/manual-registration-existing-devices .md) | Güncelleştirilmiş [makaleNin önkoşulları Microsoft Managed Desktop](get-ready/prerequisites.md) | Güncelleştirilmiş [Makaledeki Güvenlik Microsoft Managed Desktop](service-description/security-operations.md) | Yeni makale [Yönetici portalına erişim |](get-started/access-admin-portal.md) Güncelleştirilmiş makale [Kurumlar için Microsoft 365 Uygulamaları](get-started/m365-apps.md) | Yeni makale[: Gizlilik ve kişisel veriler](service-description/privacy-personal-data.md) | Yeni makale

## <a name="july-2020"></a>Temmuz 2020

Yeni veya değiştirilmiş makale | Açıklama
--- | ---
[Microsoft Managed Desktop gereksinimlerini karşıla](service-description/mmd-app-requirements.md) | Makale güncelleştirildi
[Uyumluluk](intro/compliance.md) | Makale güncelleştirildi
[Kullanmaya başlayın denetimi ile birlikte uygulama](get-started/get-started-app-control.md) | Makale güncelleştirildi
...
[Microsoft Microsoft Project veya Microsoft Visio'u Microsoft Managed Desktop cihazlara yükleme](get-started/project-visio.md) | Makale güncelleştirildi
...
[Microsoft Managed Desktop bölge ve dilleri seçin](service-description/regions-languages.md) | Makale güncelleştirildi
...
[İş Ortakları'nın cihazları kaydetme adımları](get-started/partner-registration.md)| Makale güncelleştirildi
[Yeni cihazları kendiniz kaydettirin](get-started/manual-registration.md) | Makale güncelleştirildi
[Yazdırma kaynaklarını diğer kaynaklara Microsoft Managed Desktop](get-ready/printing.md) | Yeni makale

## <a name="february-2020"></a>Şubat 2020

Yeni veya değiştirilmiş makale | Açıklama
--- | ---
[Güvenlik Microsoft Managed Desktop](service-description/security.md)| Makale güncelleştirildi
Öngörülerle çalışma | Makale güncelleştirildi
Windows güncelleştirme içgörülerini güncelleştirme| Yeni makale
[Güncelleştirmeler iş nasıl Microsoft Managed Desktop](service-description/updates.md) | Makale güncelleştirildi
[Microsoft Managed Desktop hizmetlerini açın](service-description/device-services.md) | Makale güncelleştirildi
...
[Destek için Microsoft Managed Desktop](working-with-managed-desktop/admin-support.md) | Makale güncelleştirildi
[Microsoft Managed Desktop cihazları](service-description/device-list.md) | Makale güncelleştirildi
[Microsoft Managed Desktop arşivlenmiş cihazları](service-description/archived-device-list.md) | Makale güncelleştirildi
...
[Microsoft Managed Desktop cihazları](service-description/device-list.md) | Makale güncelleştirildi
[Microsoft Managed Desktop ana sayfa](./index.yml) | Makale güncelleştirildi
[Microsoft Yönetilen Masaüstü nedir?](./intro/index.md) | Makale güncelleştirildi
[Kullanıcılarınızı cihazları kullanmaya hazır hale get get your users](get-started/get-started-devices.md) | Makale güncelleştirildi
...
[Destek için Microsoft Managed Desktop](working-with-managed-desktop/admin-support.md) | Makale güncelleştirildi
[Microsoft Managed Desktop için önkoşullar](get-ready/prerequisites.md) | Makale güncelleştirildi
[Cihazları Microsoft Managed Desktop ayarlama](get-started/prepare-devices.md) | Yeni makale
[Yeni cihazları kendiniz kaydettirin](get-started/manual-registration.md) | Makale güncelleştirildi
...
[Microsoft Managed Desktop sorumluluklarını yerine getirme](intro/roles-and-responsibilities.md) | Makale güncelleştirildi
[Microsoft Managed Desktop yaşam döngüsünü geri arama](service-description/device-lifecycle.md) | Yeni makale
...
[Microsoft Managed Desktop bölge ve dilleri seçin](service-description/regions-languages.md) | Makale güncelleştirildi
[Microsoft Managed Desktop cihazları](service-description/device-list.md) | Makale güncelleştirildi
[Microsoft Managed Desktop arşivlenmiş cihazları](service-description/archived-device-list.md) | Yeni makale
[Eşlenmiş sürücüleri sürücüye Microsoft Managed Desktop](get-ready/mapped-drives.md) | Yeni makale
[Sertifika ve ağ profillerini e-Microsoft Managed Desktop](get-ready/certs-wifi-lan.md) | Yeni makale
[Cihaz Microsoft Managed Desktop sipariş edin](get-started/devices.md) | Makale güncelleştirildi
...
Yeni veya değiştirilmiş makale | Açıklama
--- | ---
[Intune Şirket Portalı cihazlarına Microsoft Managed Desktop yükleme](get-started/company-portal.md) | Yeni makale
[Microsoft Project cihazlarına Microsoft Visio'i Microsoft Managed Desktop yükleme](get-started/project-visio.md) | Yeni makale
[Şirket içi kaynaklara erişimi diğer kaynaklara Microsoft Managed Desktop](get-ready/authentication.md) | Yeni makale
[Cihazları Posta'ya Microsoft Managed Desktop](get-started/manual-registration.md) | Yeni makale
[Cihazları İş Ortakları için Microsoft Managed Desktop'e kaydetme](get-started/partner-registration.md) | Yeni makale
[Uygulamaları diğer Microsoft Managed Desktop dağıtma](get-started/deploy-apps.md) | Makale güncelleştirildi
...
[Kullanmaya başlayın ile bağlantı](get-started/get-started-devices.md) | Yeni makale

## <a name="january-2019"></a>Ocak 2019

Yeni veya değiştirilmiş makale | Açıklama
--- | ---
[Microsoft Managed Desktop cihazları için uygulama dağıtma](get-started/deploy-apps.md) | Yeni makale.
[Uygulamalar için uygulamaları Microsoft Managed Desktop](working-with-managed-desktop/manage-apps.md) | İş hattı uygulamalarının önceki bir sürümüne güncelleştirme veya geri dönmeyle ilgili bilgilerle güncelleştirildi.

## <a name="december-2018"></a>Aralık 2018

Yeni veya değiştirilmiş makale | Açıklama
--- | ---
[Diğer sistemlerde işlemler ve Microsoft Managed Desktop](service-description/operations-and-monitoring.md) | Sorumluluk tablosu bakiyesi eklendi ve diğer tablolar güncelleştirildi.
[Destek için Microsoft Managed Desktop](working-with-managed-desktop/admin-support.md) | Güncelleştirilmiş destek türleri, önem derecesi açıklamaları ve ek ayrıntılar.

## <a name="november-2018"></a>Kasım 2018

Yeni veya değiştirilmiş makale | Açıklama
--- | ---
[Destek Microsoft Managed Desktop](service-description/support.md)<br />kullanıcı [desteğine Microsoft Managed Desktop](working-with-managed-desktop/end-user-support.md) | Avustralya'yı da içerecek şekilde güncelleştirilir.

## <a name="october-30-2018"></a>30 Ekim 2018

İçerik yeniden düzenlenmiş: Hizmet açıklamasının [Microsoft Managed Desktop bölümü eklendi](service-description/index.md).
