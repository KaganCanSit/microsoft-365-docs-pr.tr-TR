...
[Yeni cihazları kendiniz kaydettirin](get-started/register-devices-self.md) | Makale güncelleştirildi
...
[İş Ortakları'nın cihazları kaydetme adımları](get-started/register-devices-partner.md) | Makale güncelleştirildi
[Yeni cihazları kendiniz kaydettirin](get-started/register-devices-self.md) |Makale güncelleştirildi
...
Yeni veya değiştirilmiş makale | Açıklama
--- | ---
[Microsoft Yönetilen Masaüstü cihazlarını ayarlama](get-started/set-up-devices.md) | Makale güncelleştirildi
...
[İş Ortakları'nın cihazları kaydetme adımları](get-started/register-devices-partner.md) | Makale güncelleştirildi
[Yeni cihazları kendiniz kaydettirin](get-started/register-devices-self.md) | Makale güncelleştirildi
[Mevcut cihazları kendiniz kaydettirin](get-started/register-reused-devices-self.md) | Makale güncelleştirildi
...
[Mevcut cihazları kendiniz kaydettirin](get-started/register-reused-devices-self.md) | Makale güncelleştirildi
[Microsoft Yönetilen Masaüstü için önkoşullar](get-ready/prerequisites.md) | Makale güncelleştirildi
[Microsoft Yönetilen Masaüstü'ne yönelik güvenlik işlemleri](service-description/security-operations.md) | Yeni makale
[Yönetici portalına erişme](get-started/access-admin-portal.md) | Makale güncelleştirildi
[Microsoft 365 Kurumsal Uygulamaları](get-started/m365-apps.md) | Yeni makale
[Gizlilik ve kişisel veriler](service-description/privacy-personal-data.md) | Yeni makale
...
[Microsoft Yönetilen Masaüstü için yönetici desteği](working-with-managed-desktop/admin-support.md) | Makale güncelleştirildi
[Microsoft Yönetilen Masaüstü için önkoşullar](get-ready/prerequisites.md) | Makale güncelleştirildi
[Microsoft Yönetilen Masaüstü cihazlarını ayarlama](get-started/set-up-devices.md) | Yeni makale
[Yeni cihazları kendiniz kaydettirin](get-started/register-devices-self.md) | Makale güncelleştirildi
[Mevcut cihazları kendiniz kaydettirin](get-started/register-reused-devices-self.md) | Yeni makale
[Microsoft Yönetilen Masaüstü'de güncelleştirmeler nasıl yönetilir?](service-description/updates.md) | Makale güncelleştirildi
...
[Cihazları Microsoft Yönetilen Masaüstü'ne kaydetme](get-started/register-devices-self.md) | Yeni makale
[Cihazları İş Ortakları için Microsoft Yönetilen Masaüstü'ne kaydetme](get-started/register-devices-partner.md) | Yeni makale
