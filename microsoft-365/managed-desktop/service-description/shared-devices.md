...
## <a name="register-new-devices-using-the-windows-autopilot-self-deploying-mode-profile"></a>Windows Autopilot kendi kendine dağıtım modu profilini kullanarak yeni cihazları kaydetme
